<?php
/**
 * Title: Cover with big heading 2candles
 * Slug: twoCandles/banner-cover-big-heading-2candles
...
<div class="wp-block-group alignfull is-style-section-3" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)">
	...
	<div class="wp-block-group alignwide">
		...
		<figure class="wp-block-image alignwide size-full">
			<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/2880x2046.png" alt="<?php esc_attr_e( '2880x2046, 2880x2046', 'twoCandles' ); ?>"/>
		</figure>
		<!-- /wp:image -->
		...
		<div class="wp-block-group alignfull">
			...
			<h2 class="wp-block-heading has-text-align-left" style="font-size:clamp(1rem, 380px, 24vw);font-style:normal;font-weight:700;letter-spacing:-0.02em;line-height:1"><?php echo esc_html_e( '2Candles', 'twoCandles' ); ?></h2>
			<!-- /wp:heading -->
